"""ai.prompts.hierarchy_extractor_prompt — System prompt for HierarchyExtractorAgent."""
...
HIERARCHY_EXTRACTOR_SYSTEM_PROMPT = (
    ...
    "analiz edip mantıklı bir başlık/bölüm hiyerarşisi oluşturmaktır.\n\n"
    ...
    "3. Her bölüm için id (örn: chapter_1), title, page_start, page_end, summary (Türkçe 1-2 cümlelik kısa özet), "
    "topics (3-5 ana konu) ve keywords (3-5 teknik anahtar kelime) alanlarını üret.\n"
    "4. Yanıtın tam olarak aşağıdaki JSON şemasına uymalıdır:\n"
    "{\n"
